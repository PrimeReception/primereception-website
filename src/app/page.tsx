          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
              <div className="text-center">
                ...
                <h3 className="mt-5 font-serif text-xl font-bold text-navy">Trained on you</h3>
                <p className="mt-3 text-sm text-text-body leading-relaxed max-w-xs mx-auto">
              ...
              <div className="text-center">
                ...
                <h3 className="mt-5 font-serif text-xl font-bold text-navy">Built with guardrails</h3>
                <p className="mt-3 text-sm text-text-body leading-relaxed max-w-xs mx-auto">
              ...
              <div className="text-center">
                ...
                <h3 className="mt-5 font-serif text-xl font-bold text-navy">All-in-one front desk</h3>
                <p className="mt-3 text-sm text-text-body leading-relaxed max-w-xs mx-auto">
        ...
        <section className="bg-white py-20 md:py-28">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center mb-16">
              ...
              <p className="mt-4 text-text-body">
                Industry research consistently shows the same pattern: when the phone rings and nobody picks up, the caller moves on.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  stat: "62%",
                  desc: "of calls to small businesses go unanswered",
                  source: "Forrester Research",
                },
                {
                  stat: "85%",
                  desc: "of callers who can\u2019t reach you won\u2019t call back",
                  source: "BrightLocal Consumer Survey",
                },
                {
                  stat: "$1.6M",
                  desc: "in revenue lost annually by the average SMB due to missed calls",
                  source: "Vonage / NewVoiceMedia",
                },
                {
                  stat: "67%",
                  desc: "of customers hang up when they can\u2019t reach a real person",
                  source: "Zendesk CX Trends Report",
                },
              ].map((item) => (
                <div key={item.stat} className="text-center rounded-2xl border border-navy/10 bg-cream p-8">
                  <p className="text-4xl font-bold text-teal sm:text-5xl">{item.stat}</p>
                  <p className="mt-3 text-sm text-navy font-medium leading-snug">{item.desc}</p>
                  <p className="mt-2 text-[11px] text-text-body/50">{item.source}</p>
                </div>
              ))}
            </div>
            ...
            <div className="mx-auto max-w-xl mt-12 text-center">
              <p className="text-sm text-text-body leading-relaxed">
                Every missed call is a missed opportunity. Prime Reception ensures your phone is always answered — professionally, instantly, and on-brand.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="relative bg-navy py-20 md:py-28 overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <blockquote className="mx-auto max-w-3xl text-center">
              <p className="font-serif text-2xl font-bold text-white leading-snug sm:text-3xl lg:text-4xl">
                We&apos;re building the future of how small businesses handle phone calls — and we&apos;re just getting started.
              </p>
              <p className="mt-6 text-sm text-white/60">
                Prime Reception is a new company on a mission to make sure no small business ever loses a customer to a missed call again.
              </p>
            </blockquote>
