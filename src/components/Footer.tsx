    ...
    <footer className="bg-cream">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
            ...
            <ul className="mt-5 space-y-3">
              <li>
                <a
                  ...
                  className="text-sm text-text-body hover:text-navy transition-colors"
                >
          ...
          {/* Company */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-widest text-navy">
              Company
            </h4>
            <ul className="mt-5 space-y-3">
              {[
          ...
          <div>
            ...
            <div className="mt-5 flex gap-3">
              ...
              <a
                href="#"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-navy/20 text-navy hover:bg-navy hover:text-white transition-colors"
                aria-label="Twitter"
              >
